...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("scarrymaze.jpg"));
		//2. set the mouse pointer to the start of your maze using:
		new Robot().mouseMove(25, 70);
...
int end=-16711692;
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("wickedwitchlaugh.wav"));
